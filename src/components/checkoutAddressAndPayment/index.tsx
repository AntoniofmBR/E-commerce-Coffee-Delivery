...
export function CheckoutAddressAndPayment() {
  const { CEP, setCEP, Road, setRoad, Number, setNumber, Complement, setComplement, Neighborhood, setNeighborhood, City, setCity, UF, setUF, formOfPayment, setFormOfPayment } = useContext(UserDataContext);
